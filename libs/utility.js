...
export const getCategories = async () => {
  ...
  const response = await fetch("https://doldor.com/api/v1/category/fetch/100", requestOptions);
...
export const getBrands = async () => {
  ...
  const response = await fetch("https://doldor.com/api/v1/brand/fetch/100", requestOptions);
  const result = await response.text();
...
const response = await fetch(`https://doldor.com/api/v1/product/show/${id}`, requestOptions);
    const result = await response.text();
